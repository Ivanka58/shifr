...
export default function Notifications() {
  ...
  const items = [
    { key: "notificationsEnabled", label: "Уведомления", desc: "Включить уведомления" },
    { key: "notificationSound", label: "Звук", desc: "Звук при уведомлениях" },
    { key: "notificationPreview", label: "Предпросмотр", desc: "Показывать текст в уведомлениях" },
  ];

  return (
    <Layout title="УВЕДОМЛЕНИЯ">
      <div className="max-w-md mx-auto p-6">
        <div className="text-xs tracking-widest opacity-60 mb-6">УВЕДОМЛЕНИЯ</div>
